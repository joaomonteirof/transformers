...
_import_structure = {
    ...
    "models.stackt5": ["STACKT5_PRETRAINED_CONFIG_ARCHIVE_MAP", "StackT5Config"],
...
try:
    ...
    _import_structure["models.stackt5"].extend(
        [
...
if TYPE_CHECKING:
    ...
    from .models.stackt5 import STACKT5_PRETRAINED_CONFIG_ARCHIVE_MAP, StackT5Config
